...
/**
 * Created by Kaola on 2015/12/31. Newton Iterative Method using tangential equation as iterative
 * method is a better solution to compute the solution of a Non-Linear Equation,which has a faster
 * convergence order.
 */
...
//		double solution = nim.execute("(x-1)^3","(x-1)^2",2000,0.0001,0.0003);
   ...
   */
  public double execute(String func, String derivationFunc, double x0, double alpha0, double alpha1)
      throws Exception {
    JEP jep = new JEP();
    ...
    do {
      ...
      System.out.println(
          "iterTime is :" + (++iterTime) + " and xCur value is :" + xCur + "and xNext value is :"
              + xNext + " and solution is :" + solution);
